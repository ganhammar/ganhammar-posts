...
> [!NOTE]
> Worth re-checking before you copy the definitions across: once these
> land in `@types/aws-lambda`, the local declarations become a
> conflicting duplicate rather than a missing piece.
