...
> [!NOTE]
> Removing an edge function later is also a two-step affair. CloudFront
> has to replicate the deletion to every location before the stack will
> come down, and that can take the better part of an hour.
