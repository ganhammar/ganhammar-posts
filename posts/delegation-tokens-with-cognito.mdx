...
Lastly we will create the Verify Auth Challenge Response Lambda. This Lambda needs to verify the end-users Access Token, which there is loads of examples of out there. The source code for how I did it in the example below can be found [here](https://github.com/ganhammar/delegation-with-amazon-cognito/blob/main/lib/handlers/utils/verify-token.ts).
