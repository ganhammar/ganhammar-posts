...
Resources:
  ...
  OpenIddictFunction:
    ...
    Properties:
      ...
      Handler: OpenIddictServerlessDemo::OpenIddictServerlessDemo.LambdaEntryPoint::FunctionHandlerAsync
      Events:
        Api:
          Type: HttpApi
          Properties:
        ...
        - Statement:
          ...
          - Effect: Allow
            Action:
              - dynamodb:Query
            Resource:
              - Fn::Sub: arn:aws:dynamodb:${AWS::Region}:${AWS::AccountId}:table/openiddict-serverless-demo.openiddict/index/*
