...
> [!NOTE]
> Origin modification is the reason for the 2.0 runtime specifically.
> The `cloudfront` module that exposes `updateRequestOrigin` does not
> exist in the 1.0 runtime.
